...
df.select(year($"Date")).show()
  ...
  The knowledge circulates from the general to the particular in
  this sense the explanation of new phenomena canbe studied by 
  the relationship it has with events of the same phenomenon 
 ...
 <a href="https://imgflip.com/gif/3q2x5r"><img src="https://i.imgflip.com/3q2x5r.gif" title="made at imgflip.com"/></a>
